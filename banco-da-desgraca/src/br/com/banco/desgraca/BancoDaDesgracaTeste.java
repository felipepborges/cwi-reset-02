...
public class BancoDaDesgracaTeste {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ContaBancaria bbCc = new ContaCorrente(111, BANCO_DO_BRASIL);
        ContaBancaria bradescoCc = new ContaCorrente(222, BRADESCO);
        ContaBancaria caixaCc = new ContaCorrente(333, CAIXA);
        ContaBancaria itauCc = new ContaCorrente(444, ITAU);
        ContaBancaria nubankCc = new ContaCorrente(555, NUBANK);
        CONTAS_CORRENTE.addAll(asList(bbCc, bradescoCc, caixaCc, itauCc, nubankCc));

        ContaBancaria bbPoupanca = new ContaPoupanca(666, BANCO_DO_BRASIL);
        ContaBancaria bradescoPoupanca = new ContaPoupanca(777, BRADESCO);
        ContaBancaria caixaPoupanca = new ContaPoupanca(888, CAIXA);
        ContaBancaria itauPoupanca = new ContaPoupanca(999, ITAU);
        CONTAS_POUPANCA.addAll(asList(bbPoupanca, bradescoPoupanca, caixaPoupanca, itauPoupanca));

        ContaBancaria itauDigital = new ContaDigital(100,ITAU);
        ContaBancaria nubankDigital = new ContaDigital(101, NUBANK);
    ...
    private static void verificarContasQueNaoPodemSerCriadas() {
        ...
        contaInvalida(() -> new ContaDigital(456, BANCO_DO_BRASIL));
        contaInvalida(() -> new ContaDigital(789, BRADESCO));
        contaInvalida(() -> new ContaDigital(123, CAIXA));

        contaInvalida(() -> new ContaPoupanca(741, NUBANK));
    }
    ...
    private static void contaInvalida(Supplier<ContaBancaria> conta) {
        ...
        } catch (InstituicaoBancariaException ibie) {
        }
    }
